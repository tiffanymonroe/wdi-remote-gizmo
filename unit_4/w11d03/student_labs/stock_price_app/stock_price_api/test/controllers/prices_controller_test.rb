...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { avg_price: @price.avg_price, date: @price.date, stock_id: @price.stock_id } }, as: :json
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { avg_price: @price.avg_price, date: @price.date, stock_id: @price.stock_id } }, as: :json
    assert_response 200
  end
